...
(?U)access_token=(.*)&`,
		...
		{Key: conf.SSOOIDCRolesKey, Value: "roles", Type: conf.TypeString, Group: model.SSO, Flag: model.PRIVATE},
		...
		{Key: conf.SSOExtraScopes, Value: "groups", Type: conf.TypeString, Group: model.SSO, Flag: model.PRIVATE},
		...
		// acl settings
		{Key: conf.ACLEnabled, Value: "false", Type: conf.TypeBool, Group: model.GLOBAL, Flag: model.PRIVATE},
